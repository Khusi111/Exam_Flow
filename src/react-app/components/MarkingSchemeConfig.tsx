    ...
    switch (type) {
      case 'Single Correct MCQ':
        return [
          ...
          '❌ In Any other case (-ve marking): Negative marking'
        ];
      case 'Multiple Correct MCQ':
        return [
          '✅ Correct options marked: Marks per correct option',
          '❌ Incorrect options marked: Negative marking per incorrect option',
      ...
      case 'Numerical':
        return [
          ...
          '❌ Wrong value: Negative marking (if enabled)',
      ...
      case 'True/False':
        return [
          ...
          '❌ Wrong answer: Negative marking (if enabled)'
        ];
      case 'Fill in the Blanks':
        return [
          '✅ Correct answer: Full marks',
