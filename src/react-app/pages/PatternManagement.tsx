            ...
            <div key={pattern.id} className="bg-white rounded-lg border border-slate-200 p-4 hover:shadow-md transition-shadow">
              ...
              <div className="flex items-center gap-2">
                <Link
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-1 px-2 py-1 text-xs bg-green-50 text-green-700 rounded hover:bg-green-100 transition-colors"
                >
