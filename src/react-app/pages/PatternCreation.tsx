  ...
  const handleSave = async () => {
    ...
    try {
      const patternData = {
        ...
        total_marks: pattern.sections.reduce((sum, section) => sum + ((section.end_question - section.start_question + 1) * section.marking_scheme.max_marks), 0),
      };
                          ...
                          <div key={globalIndex} className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                                ...
                                <select
                                  ...
                                  onChange={(e) => {
                                    ...
                                    if (newType === 'Subjective') {
                                      ...
                                      updatedScheme.negative_marking_percentage = 0;
                            ...
                            <div className="mt-2 flex items-center justify-between text-xs text-slate-600">
                              ...
                              <div className="font-medium">
                                Total: {(section.end_question - section.start_question + 1) * section.marking_scheme.max_marks} marks
                              </div>
                            </div>
                          </div>
                        );
